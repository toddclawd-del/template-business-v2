...
import { PRODUCT, FOOTER_LINKS } from '../lib/data'
...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-[rgb(var(--border))] py-16">
      <div className="container-default">
        <div className="grid md:grid-cols-6 gap-8 mb-12">
          <div className="md:col-span-2">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm max-w-xs mt-4">
              Building the future of product development. Ship faster, collaborate better.
            </p>
          </div>
        ...
        <div className="border-t border-[rgb(var(--border))] pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-gray-500 text-sm">
            © {currentYear} {PRODUCT.name} Inc. All rights reserved.
          </p>
