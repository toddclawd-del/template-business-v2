...
const footerLinks = {
  properties: [
    ...
    { name: "New Listings", href: "/listings?sort=newest" },
    { name: "Sold Properties", href: "/listings?status=sold" },
    { name: "Open Houses", href: "/listings" },
  ],
  neighborhoods: [
    { name: "Beverly Hills", href: "/listings?neighborhood=beverly-hills" },
    { name: "Malibu", href: "/listings?neighborhood=malibu" },
    { name: "Bel Air", href: "/listings?neighborhood=bel-air" },
    { name: "Hollywood Hills", href: "/listings?neighborhood=hollywood-hills" },
  ],
  company: [
    { name: "About Us", href: "/about" },
    { name: "Our Agents", href: "/agents" },
    { name: "Careers", href: "/agents" },
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="space-y-2 text-dark-400 text-sm">
              ...
              <p className="text-gold">{companyInfo.phone}</p>
          ...
          {/* Properties */}
          <div>
            <h4 className="text-dark-100 font-semibold mb-4 text-sm uppercase tracking-wider">
              Properties
            </h4>
            <ul className="space-y-3">
              {footerLinks.properties.map((link) => (
                <li key={link.name}>
                  <Link
                    href={link.href}
                    className="text-dark-400 hover:text-gold transition-colors text-sm"
                  >
                    {link.name}
                  </Link>
                </li>
