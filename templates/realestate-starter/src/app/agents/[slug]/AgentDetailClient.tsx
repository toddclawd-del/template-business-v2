      ...
      <div className="bg-dark-900 border-b border-dark-800 py-4">
        <div className="container-custom">
          <nav className="flex items-center gap-2 text-sm">
            ...
            <span className="text-dark-600">/</span>
            <span className="text-dark-200">{agent.name}</span>
          </nav>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              >
                <div className="flex flex-col md:flex-row gap-6">
                  ...
                  <div className="text-center md:text-left">
                    <h1 className="heading-2 text-dark-100 mb-1">{agent.name}</h1>
                    <p className="text-gold text-lg mb-4">{agent.title}</p>
                    ...
                    <div className="flex flex-wrap justify-center md:justify-start gap-6">
                      ...
                      <div>
                        ...
                        <p className="text-dark-400 text-sm">Properties Sold</p>
                      </div>
                      <div>
                        <p className="text-2xl font-display font-bold text-gradient">
                          {agent.salesVolume}
                        </p>
                        <p className="text-dark-400 text-sm">Sales Volume</p>
                      </div>
                    </div>
              ...
              <motion.div
                ...
                className="card p-6 md:p-8"
              >
                <h2 className="heading-3 text-dark-100 mb-4">About {agent.name}</h2>
                <p className="text-dark-300 leading-relaxed">{agent.bio}</p>
              </motion.div>
              ...
              <motion.div
                ...
                className="card p-6 md:p-8"
              >
                <h2 className="heading-3 text-dark-100 mb-4">Specializations</h2>
                <div className="flex flex-wrap gap-3">
                  {agent.specializations.map((spec) => (
                    <span
                      key={spec}
                      className="px-4 py-2 bg-dark-800 text-dark-200 rounded-sm text-sm"
                    >
                      {spec}
                    </span>
                  ))}
              ...
              <motion.div
                ...
                className="card p-6 md:p-8"
              >
                <h2 className="heading-3 text-dark-100 mb-4">Languages</h2>
                <div className="flex flex-wrap gap-3">
                  {agent.languages.map((lang) => (
                    <span
                      key={lang}
                      className="px-4 py-2 border border-dark-700 text-dark-300 rounded-sm text-sm"
                    >
                      {lang}
                    </span>
                  ))}
              ...
              >
                ...
                <div className="space-y-4">
                  <a
                    ...
                    className="flex items-center gap-3 text-dark-300 hover:text-gold transition-colors"
                  >
                    <svg
                      className="w-5 h-5"
                      fill="none"
        ...
        <section className="bg-dark-900 section-padding">
          <div className="container-custom">
            ...
            >
              ...
              <h2 className="heading-3 text-dark-100">
